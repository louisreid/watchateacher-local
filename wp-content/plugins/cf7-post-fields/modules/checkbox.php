...
if(!class_exists('wpcf7_post_fields_checkbox') )
{
    class wpcf7_post_fields_checkbox extends wpcf7_post_fields_module
    {
        ...
        {
            // Add shortcode
            add_action( 'wpcf7_init', array($this, 'wpcf7_add_shortcode_post_checkbox'));
        ...
        public function wpcf7_add_shortcode_post_checkbox()
        {
            if (function_exists('wpcf7_add_form_tag')) {
                wpcf7_add_form_tag(array('post_checkbox', 'post_checkbox*', 'post_radio'), array($this, 'wpcf7_post_checkbox_shortcode_handler'), true);
            }
        }
